  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      if (receipt.status.toString() === "SUCCESS") {
        toast.success(`Payment successful! Transaction ID: ${txResponse.transactionId.toString()}`);
        clearCart();
      } else {
      ...
      toast.error("Payment failed. Please check your credentials and try again.");
    } finally {
              ...
              <Card className="border-border sticky top-20">
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    <div className="border-t border-border pt-3">
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        ≈ {(getTotalPrice() * 10).toFixed(2)} HBAR
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4 mb-6">
                    <div>
                      <label className="text-sm font-medium mb-2 block">Hedera Account ID</label>
                      <Input
